...
//void BuildSimilarityCliques(vector<Site *> &sites, vector<vector<int> > &cliquesDuSite, vector<Clique> &cliques){
...
//        if (rec < 0.000000001) {
//            sitesaux.insert(sites[i]->node);
//            sitesaux.insert(sites[j]->node);
//            sitesindexes.insert(i);
//            sitesindexes.insert(j);
//            }
//
...
//
//    BuildMaximalOrderCliques(sites, cliquesDuSite, cliques);
//
//    BuildDataDrivenCliques(sites, cliquesDuSite, cliques);
//
//    BuildSimilarityCliques(sites, cliquesDuSite, cliques);
//
//    return cliques;
//}
