         ...
         for (uint j=0; j<intersMod.size();j++){
            ...
            if (verifGyriExistence(g, gHaut, gBas, corres)){
               ...
               if (!(hautBas.first.empty() || hautBas.second.empty())){
                  ...
                  if (hautBas.first.empty()) printf("Attention : d�tection intersection \"haut\" foireuse.\n");
                  if (hautBas.second.empty()) printf("Attention : d�tection intersection \"bas\" foireuse.\n");
               }
          ...
          /*
                  ...
                  printf("Attention : d�tection intersections \"gaucheDroite\" foireuse.\n");
               }
            }
            else {
