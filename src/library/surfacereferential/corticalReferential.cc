...
{
	std::cout<<"avant preprocess..."<<std::endl;
	...
	std::cout<<"apres preprocess..."<<std::endl;
...
//Preprocessing constraints (i.e. pole stuff

void CorticalReferential::constraintPreprocess()
{
	//finding poles
	
	std::cout<<"dedans preprocess..."<<std::endl;
	Reader < TimeTexture<float> > rtp(adr_par);
	...
	std::cout<<"findpoles ok..."<<std::endl;
...
/*			for ( int i=0; i<size; i++)
		...
		iter++;
		//////////////////////////////////////////////
		// A VIRER, C'EST JUSTE POUR UN TEST!!!
		//////////////////////////////////////////////
// 		if ((iter%1000)==0)
// 			break;
		//////////////////////////////////////////////
