...
def execution( self, context ):
    ...
    if self.Side in ('Left','Both'):
        ...
        if self.coord in ('Longitude','Both'):
            ...
            self.gyri_model = os.environ['P4'] + '/shared-main/models/3.0/gyrus/surfaceRef_mer.gyr'
        ...
        if self.coord in ('Latitude','Both'):
            ...
            self.gyri_model = os.environ['P4'] + '/shared-main/models/3.0/gyrus/surfaceRef_par.gyr'
